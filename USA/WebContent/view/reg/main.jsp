...
<%-- <jsp:include page="/view/headfoot/header.jsp" flush="false" />
 ...
 --%>
		<div data-obj-type="group" data-obj-id="EWRJM" class=""
			style="position: absolute; left: 170px; top: 200px; width: 200px; height: 153px;">
			<div data-obj-id="rG84l" data-obj-type="element"
				data-text-editable="true" class=""
				style="position: absolute; top: 0px; left: 32px; width: 162px; height: 153px;">
		...
		<div data-obj-type="group" data-obj-id="tnOsS" class=""
			style="position: absolute; left: 215px; top: 200px; width: 200px; height: 153px;">
			<div data-obj-id="C115b" data-obj-type="element"
				data-text-editable="true" class=""
				style="position: absolute; top: 0px; left: 25px; width: 180px; height: 153px;">
				<div data-text-content="true"
					style="border-radius: 25%; background-color: rgb(224, 224, 224);"></div>
			</div>
		...
		<div data-obj-type="group" data-obj-id="ng9XU" class=""
			style="position: absolute; left: 255px; top: 200px; width: 200px; height: 153px;">
			<div data-obj-id="gNN6D" data-obj-type="element"
				data-text-editable="true" class=""
				style="position: absolute; top: 0px; left: 30px; width: 180px; height: 153px;">
				<div data-text-content="true"
					style="border-radius: 25%; background-color: rgb(224, 224, 224);"></div>
			</div>
		...
		<div data-obj-type="group" data-obj-id="bVE7E" class=""
			...
			<div data-obj-id="olbIl" data-obj-type="element"
				...
				<div data-text-content="true"
					style="font-size: 9.5px; color: rgb(64, 64, 64); text-align: center; line-height: 2.5em; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom-right-radius: 4px; border-bottom-left-radius: 4px; background-color: rgb(224, 224, 224);"
					class="">
					관광명소
					<div>
						<br>
